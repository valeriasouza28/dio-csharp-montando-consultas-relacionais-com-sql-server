...
--Buscar Filmes por Nome e Ano
SELECT Nome, Ano 
FROM Filmes;

--Buscar o nome dos filmes e a duração com os nomes dos atores principais
SELECT Nome, Ano
FROM Filmes
ORDER BY Ano ASC;
...
-- Buscar o nome do filme e os atores, trazendo o PrimeiroNome, 
